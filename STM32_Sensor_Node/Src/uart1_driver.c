 ...
 * Reads the byte from the data register and hands it off to Router layer for processing.
 * 
 * The ISR needs to be very short -> immediately read DR and get read for the next byte
*/
